...
export function HeroBanner() {
  return (
    <section className="relative h-[80vh] min-h-[600px] w-full bg-secondary overflow-hidden">
      ...
      <div className="relative z-10 h-full max-w-7xl mx-auto px-4 md:px-10 flex flex-col justify-center items-start">
